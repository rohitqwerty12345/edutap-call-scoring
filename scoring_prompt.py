...
- TRANSCRIPT SPELLING TOLERANCE: This transcript is auto-generated from a call recording using speech-to-text. Words will frequently be misspelled or appear phonetically. Course names, platform names, and exam names may appear in distorted forms — for example "edutab" or "add o tab" instead of "EduTap", "ups epf" instead of "UPSC EPFO", "apf c" instead of "APFC", "e o" instead of "EO". Do NOT flag these as factual errors or Guardrails failures. Judge meaning, not spelling. Only flag something as factually wrong if the actual claim being made is incorrect — not the phonetic transcription of a word or name.
- FREE OFFERINGS TOLERANCE: The agent may offer complimentary services not listed in the paid course information — that are Strategy calls (1-1), Calendly sessions, LG workshop, LN workshop, Starter packs, Demo courses, Few trials within our paid courses, Interview guidance bundles are free (RBI, SEBI & NABARD), 1st Free mock interview (online) for (RBI, SEBI & NABARD), Solved PYQs, Guidebooks, Current affair boosters (available on our website), E-books (available on our website), Mock tests (available on our website), Yt free videos with Pdfs on telegram (CT 360, Finance 360, Govt schemes, Perspective 360, ARD Current affairs for NABARD), and Exam preparation & Strategy videos on YT. These are the only free offerings do NOT flag these as false information or Guardrails failures. These are on the only approved free offerings. Only flag as false information if the agent makes a wrong claim about a paid course feature, its price, its included content, or its validity period.
...

{
  ...
  "top_strength": {
    "summary": "Two to three sentences summarising the strongest thing the agent did across the entire call.",
    "by_parameter": {
      "guardrails": "What the agent did well here specifically, with exact quote. Write null if nothing noteworthy.",
      "opening": "What the agent did well here specifically, with exact quote. Write null if nothing noteworthy.",
      "discovery": "What the agent did well here specifically, with exact quote. Write null if nothing noteworthy.",
      "evidence": "What the agent did well here specifically, with exact quote. Write null if nothing noteworthy.",
      "resonance": "What the agent did well here specifically, with exact quote. Write null if nothing noteworthy.",
      "diagnosis": "What the agent did well here specifically, with exact quote. Write null if no objection occurred or nothing noteworthy.",
      "closure": "What the agent did well here specifically, with exact quote. Write null if nothing noteworthy."
    }
  },
  "biggest_improvement_area": {
    "summary": "Two to three sentences summarising the most critical things to fix across the call.",
    "by_parameter": {
      "guardrails": "If the agent failed or made a mistake here: exactly what was said (quote), exactly what was wrong, and exactly what should have been said instead. Write null if no issue.",
      "opening": "If the agent could have opened better: exactly what was said (quote), what was missing, and what a better opening would have sounded like with an example line. Write null if no issue.",
      "discovery": "If discovery was weak or incomplete: exactly what questions were skipped, what information was missing, and give example questions the agent should have asked. Write null if no issue.",
      "evidence": "If evidence was generic or inaccurate: exactly what was said (quote), why it was wrong or weak, and what a stronger connected evidence line would have been using what the student actually said. Write null if no issue.",
      "resonance": "If resonance was missing, generic, or fake: exactly what was said (quote), why it did not land, and what a real resonance line would have sounded like using the student's own words. Write null if no issue.",
      "diagnosis": "If diagnosis was skipped or weak: exactly what the student said, what the agent did instead (quote), and what the agent should have asked to find the real reason. Write null if no objection or no issue.",
      "closure": "If closure was incomplete: exactly what was missing, what was said (quote), and what a complete closure would have looked like for this specific call. Write null if no issue."
    }
  },
