...
def _plain_summary_text(value: Any) -> str | None:
    """
    Store user-facing GPT summary fields as plain readable text.
    If GPT returns {"summary": "...", "by_parameter": {...}}, save only summary.
    """
    if value is None:
        return None
