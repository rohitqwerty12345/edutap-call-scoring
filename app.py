...
def _readable_text(value):
    """
    Convert JSON/dict values into simple readable text.
    This is mainly for top_strength and biggest_improvement_area when GPT returns
    {"summary": "...", "by_parameter": {...}} instead of a plain string.
    """
    if value is None:
        return ""
